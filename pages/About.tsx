        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative grid grid-cols-2 gap-6">
              ...
              <div className="p-8 bg-brandRed rounded-[40px] shadow-xl shadow-brandRed/20">
                <Factory className="text-white w-8 h-8 mb-4" />
                <p className="text-xs font-black uppercase tracking-widest text-brandRed-100">Production</p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          {coreValues.map((value, i) => (
            <div key={i} className="p-10 bg-slate-900 border border-slate-800 rounded-[50px] hover:border-brandRed/50 transition-all group">
              <div className="inline-block mb-8 p-5 bg-slate-950 rounded-2xl border border-slate-800 group-hover:bg-brandRed group-hover:text-white transition-all text-brandRed">
                {value.icon}
              </div>
